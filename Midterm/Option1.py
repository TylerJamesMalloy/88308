...
### Serial Hypothesis Instance Based Learning Model
a1 = Agent(name="Contextual Bandit 1 Dimension" , attributes=["Shape", "Color", "Texture"], default_utility=1)
a2 = Agent(name="Contextual Bandit 2 Dimensions", attributes=["Shape", "Color", "Texture"], default_utility=1)
a3 = Agent(name="Contextual Bandit 3 Dimensions", attributes=["Shape", "Color", "Texture"], default_utility=1)

choices1 = [{"Shape":"Square"},{"Shape":"Circle"},{"Shape":"Triangle"}, 
           {"Color":"Red"},{"Color":"Blue"},{"Color":"Green"}, 
           {"Texture":"Hatched"}, {"Texture":"Dotted"},{"Texture":"Wavy"},]

choices2 = [{"Shape":"Square", "Color":"Red"},{"Shape":"Circle", "Color":"Red"},{"Shape":"Triangle", "Color":"Red"},
           ...
           {"Color":"Red", "Texture":"Wavy"},{"Color":"Blue", "Texture":"Wavy"},{"Color":"Green", "Texture":"Wavy"}
           ]

choices3 = [{"Shape":"Square", "Color":"Red", "Texture":"Hatched"},{"Shape":"Circle", "Color":"Red", "Texture":"Hatched"},{"Shape":"Triangle", "Color":"Red", "Texture":"Hatched"},
...
for index, row in humanData.iterrows():
    ...
    if(row['numRelevantDimensions'] == 1):
        choice = a1.choose(choices1)
    elif(row['numRelevantDimensions'] == 2):
        choice = a2.choose(choices2)
    elif(row['numRelevantDimensions'] == 3):
        choice = a3.choose(choices3)
    ...
    if(row['numRelevantDimensions'] == 1):
        a1.respond(reward_probability)
    elif(row['numRelevantDimensions'] == 2):
        a2.respond(reward_probability)
    elif(row['numRelevantDimensions'] == 3):
        a3.respond(reward_probability)
